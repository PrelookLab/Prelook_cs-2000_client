    ...
    methods
        ...
        function obj = CS2000ColorimetricData(colorArray)
            if nargin > 0 % Support calling with 0 arguments
                ...
                obj.x = colorArray{9};
                obj.y = colorArray{10};
                obj.u_ = colorArray{11};
                obj.v_ = colorArray{12};
                obj.T = colorArray{13};
                obj.delta_uv = colorArray{14};
                obj.lambda_d = colorArray{15};
                obj.Pe = colorArray{16};
                obj.X10 = colorArray{17};
                obj.Y10 = colorArray{18};
                obj.Z10 = colorArray{19};
                obj.x10 = colorArray{20};
                obj.y10 = colorArray{21};
                obj.u_10 = colorArray{22};
                obj.v_10 = colorArray{23};
                obj.T10 = colorArray{24};
                obj.delta_uv10 = colorArray{25};
                obj.lambda_d10 = colorArray{26};
                obj.Pe10 = colorArray{27};
